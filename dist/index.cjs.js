...
function FastImageBase({
  ...
  const adjustedRadius = blurRadius ? blurRadius * (reactNative.Platform.OS === 'ios' ? 3 : 0.75) : 0;
  let resolvedSource = reactNative.Image.resolveAssetSource(source);

  if (reactNative.Platform.OS === 'android') {
    resolvedSource = Object.assign({}, resolvedSource, {
